...
export default function Navbar({ onMenuClick, isMobile }) {
  ...
  const CREATE_ITEMS = [
    { label: "New Client",    href: "/clients",  icon: "◈", roles: ["ADMIN","HOD","CREATIVE_DIRECTOR","CONTENT_STRATEGIST","ACCOUNT_MANAGER","ACCOUNT_EXECUTIVE"] },
    { label: "New Job",       href: "/jobs",     icon: "◉", roles: ["ADMIN","HOD","CREATIVE_DIRECTOR","SENIOR_GRAPHIC_DESIGNER","GRAPHIC_DESIGNER","MOTION_VIDEO_EDITOR","CONTENT_STRATEGIST","ACCOUNT_MANAGER","ACCOUNT_EXECUTIVE","STAFF"] },
    { label: "Leave Request", href: "/hr",       icon: "◎", roles: ["ADMIN","HOD","CREATIVE_DIRECTOR","SENIOR_GRAPHIC_DESIGNER","GRAPHIC_DESIGNER","MOTION_VIDEO_EDITOR","CONTENT_STRATEGIST","ACCOUNT_MANAGER","ACCOUNT_EXECUTIVE","ACCOUNTANT_FINANCE","COMPLIANCE_OFFICER","HR_MANAGER","STAFF"] },
    { label: "New Invoice",   href: "/accounts", icon: "◆", roles: ["ADMIN","HOD","ACCOUNT_MANAGER","ACCOUNTANT_FINANCE"] },
